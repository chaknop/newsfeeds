    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="left_content">
            ...
            <h2><span>Related Categories</span></h2>
            <ul class="spost_nav">
            @foreach($article_category as $art)
              <li>
          ...
          <div class="btn-group pull-left"><h4>page {!! $article_category->currentPage(); !!} of  {!! $article_category->lastPage(); !!}</h4></div>
           <div class="btn-group pull-right">{{ $article_category->links() }}</div>
        </div>
      </div>
